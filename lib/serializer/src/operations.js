...
export const delegate_create_operation_fee_parameters = new Serializer(
    "delegate_create_operation_fee_parameters",
    {fee: uint64}
);

export const delegate_update_operation_fee_parameters = new Serializer(
...
export const delegate_create = new Serializer(
    "delegate_create",
    {fee: asset,
...
export const delegate_update = new Serializer(
    "delegate_update",
    {fee: asset,
    delegate: protocol_id_type("delegate"),
    delegate_account: protocol_id_type("account"),

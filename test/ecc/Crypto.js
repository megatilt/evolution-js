...
describe("ECC", function() {
    ...
    describe("Crypto", function() {
        ...
        it("generate private key from seed", function() {
            ...
            assert.equal(private_key.toPublicKey().toString(), "EVO8m5UgaFAAYQRuaNejYdS8FVLVp9Ss3K1qAVk5de6F8s3HnVbvA", "private key does not match");
        })
    ...
    describe("Derivation", ()=> {
        ...
        let to_public = PublicKey.fromStringOrThrow("EVO7vbxtK1WaZqXsiCHPcjVFBewVj8HFRd5Z5XZDpN6Pvb2dZcMqK")
        let secret = one_time_private.get_shared_secret( to_public )
        let child = hash.sha256( secret )

        // Check everything above with `wdump((child));` from the delegate_node:
        ...
        it("child from public", function() {
            assert.equal(
                ...
                "EVO6XA72XARQCain961PCJnXiKYdEMrndNGago2PV5bcUiVyzJ6iL",

...
var test = function(key) {
    describe("ECC", function() {
        describe("Key Formats", function() {
            ...
            it("Create EVO short address", function() {
                var public_key = PublicKey.fromPublicKeyString(key.public_key);
                assert.equal(key.evo_address, public_key.toAddressString());
            })
            ...
            it("EVO public key import / export", function() {
                var public_key = PublicKey.fromPublicKeyString(key.public_key);
                assert.equal(key.public_key, public_key.toPublicKeyString());
            });
...
test({
    // delegate0
    // sourced from: ./evolution/programs/utils/evo_create_key
    public_key: "EVO7jDPoMwyjVH5obFmqzFNp4Ffp7G2nvC7FKFkrMBpo7Sy4uq5Mj",
    ...
    evo_address: "EVO8DvGQqzbgCR5FHiNsFf8kotEXr8VKD3mR",
    ...
    // https://github.com/Evolution/evolution/blob/2602504998dcd63788e106260895769697f62b07/libraries/wallet/wallet_db.cpp#L103-L108
    Uncompressed_BTC:	"EVOLAFmEtM8as1mbmjVcj5dphLdPguXquimn",
    Compressed_BTC:	"EVOANNTSEaUviJgWLzJBersPmyFZBY4jJETY",
    Uncompressed_PTS:	"EVOEgj7RM6FBwSoccGaESJLC3Mi18785bM3T",
    Compressed_PTS:	"EVOD5rYtofD6D4UHJH6mo953P5wpBfMhdMEi",
    null_public_key: "EVO1111111111111111111111111111111114T1Anm"
});
